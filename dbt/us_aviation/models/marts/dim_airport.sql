...
joined as (
    select
        ...
        case a.state_code
            ...
            when 'OH' then 'Midwest'   when 'MI' then 'Midwest'
            when 'IN' then 'Midwest'   when 'IL' then 'Midwest'
            when 'WI' then 'Midwest'   when 'MN' then 'Midwest'
            when 'IA' then 'Midwest'   when 'MO' then 'Midwest'
            when 'ND' then 'Midwest'   when 'SD' then 'Midwest'
            when 'NE' then 'Midwest'   when 'KS' then 'Midwest'
            when 'DE' then 'South'     when 'MD' then 'South'
            when 'DC' then 'South'     when 'VA' then 'South'
            when 'WV' then 'South'     when 'NC' then 'South'
            when 'SC' then 'South'     when 'GA' then 'South'
            when 'FL' then 'South'     when 'KY' then 'South'
            when 'TN' then 'South'     when 'AL' then 'South'
            when 'MS' then 'South'     when 'AR' then 'South'
            when 'LA' then 'South'     when 'OK' then 'South'
            when 'TX' then 'South'
            when 'MT' then 'West'      when 'ID' then 'West'
            when 'WY' then 'West'      when 'CO' then 'West'
            when 'NM' then 'West'      when 'AZ' then 'West'
            when 'UT' then 'West'      when 'NV' then 'West'
            when 'WA' then 'West'      when 'OR' then 'West'
            when 'CA' then 'West'      when 'AK' then 'West'
            when 'HI' then 'West'
            else 'Other'
        end as us_region,
